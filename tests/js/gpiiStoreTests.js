...
(function ($) {
    ...
    var convertedExampleModel = {"http://registry.gpii.org/common/pitch":[{"value":0.8}], "http://registry.gpii.org/common/volume":[{"value":0.8}],
                                 ...
                                 "http://registry.gpii.org/common/cursorSize":[{"value":0.2}], "http://registry.gpii.org/common/readingUnit":[{"value":"Word"}],
                                 "http://registry.gpii.org/common/magnification":[{"value":1}], "http://registry.gpii.org/common/showCrosshairs":[{"value":false}],
                                 "http://registry.gpii.org/common/announceCapitals":[{"value":false}], "http://registry.gpii.org/common/magnifierEnabled":[{"value":false}],
                                 "http://registry.gpii.org/common/highContrastTheme":[{"value":"black-white"}], "http://registry.gpii.org/common/magnifierPosition":[{"value":"TopHalf"}],
                                 "http://registry.gpii.org/common/auditoryOutLanguage":[{"value":"en"}], "http://registry.gpii.org/common/highContrastEnabled":[{"value":false}],
